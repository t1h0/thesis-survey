...
<body>
  <div class="container mt-3">
    <header class="container text-center sticky-top" id="ui" style="border-width:.1em !important">
      <div class="row justify-content-between">
        <div class="col-3 p-0">
          <a id="prev" class="btn btn-info w-100 h-100 d-flex justify-content-center align-items-center disabled" href="#articleContainer" role="button" data-slide="prev">
        ...
        <div class="col-3 p-0">
          <a id="next" class="btn btn-info w-100 h-100 d-flex justify-content-center align-items-center" href="#articleContainer" role="button" data-slide="next">
        ...
        <div id="articleContainer" class="carousel slide" data-ride="carousel" data-interval="false">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <p><span class="sd"><span class="wd" lr=100 e=25 syn="ipsum">Lorem</span> <span class="wd" lr=50 e=70 syn="lorem">ipsum</span> dolor sit
                ...
                amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut
                labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et <span class="wd" lr=34 e=60 syn="et">accusam</span> et justo duo dolores et
              ...
              <p><span class="sd">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum
                dolore eu feugiat nulla facilisis at vero <span class="wd" lr=20 e=14 syn="quos">eros</span> et accumsan et iusto odio dignissim qui blandit praesent
              ...
              <p>Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat
                facer possim assum. <span class="sd"><span class="wd" lr=100 e=25 syn="ipsum">Lorem</span> <span class="wd" lr=50 e=70 syn="lorem">ipsum</span> dolor sit
                  amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut
                  labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et
